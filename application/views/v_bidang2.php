...
<body>
  ...
  <div class="container">
        <div class="table-wrapper">         
            ...
            <a class="btn btn-danger" href="<?php echo base_url('bidang2/print') ?>"> <i class="fa fa-print"></i> EXPORT</a>
            ...
            <table class="table table-bordered">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Nama Bidang Polygon <i class="fa fa-sort"></i></th>
                        <th>Koordinat</th>
                        <th>Informasi</th>
                        <th>Gambar</th>
                ...
                <tbody>
                        ...
                        <td>
                            ...
                            <a href='<?=base_url().'bidang2/edit/' . $b->id_polygon?>'   class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                            <a href='<?=base_url().'bidang2/hapus/' . $b->id_polygon?>' class='delete' title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i>
                            </a>
                            <?php } ?>
                        </td>
                        <?php } ?>
